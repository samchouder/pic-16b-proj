...
# goal here is to get to these pages:     
    ...
    def parse(self, response): 
        ...
        car_make_pages = ['https://www.kbb.com/car-finder/?manufacturers=' + x[10:].replace('_', '-').replace('/','') + '&years=2024-2024' for x in car_makes]
...
# goal here is to yield specifications for each model
    def parse_model_page(self, response):
        name = response.css('h1.css-54ra7u.e148eed13::text').get()
